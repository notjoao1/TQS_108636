...
class TripServiceMockRepoTest {
    ...
    void testFindTripsForRoute1() {
        when(tripRepository.findByRoute(route1)).thenReturn(Arrays.asList(trip1, trip2, trip4, trip5, trip6, trip7));
    ...
    void testFindTripsForInvalidRoute() {
        when(tripRepository.findByRoute(any())).thenReturn(new ArrayList<>());
