...
class CacheControllerIT {
        ...
        void testPost_ResetCache() {
                // should cache conversion between EUR and USD
                restTemplate.exchange(
                                "/api/trips?currency=USD",
                                HttpMethod.GET,
                                null,
                ...
                ResponseEntity<Map<String, CurrencyResponse>> responseCachedData = restTemplate.exchange(
                                "/api/cache/cached",
                                HttpMethod.GET, null,
                                new ParameterizedTypeReference<Map<String, CurrencyResponse>>() {
                ...
                ResponseEntity<CacheStatsDTO> responseAfterReset = restTemplate.exchange("/api/cache/stats",
                                HttpMethod.GET,
                                null,
                                CacheStatsDTO.class);
